...
> **Note**
>
> Since version 2.0.0 Windows driver has dropped the support of Appium 1, and is only compatible to Appium 2. Use the `appium driver install --package=appium-windows-driver windows`
